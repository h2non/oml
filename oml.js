/*! oml.js - v0.1.0 - MIT License - https://github.com/h2non/oml | Generated 2014-03-01 09:25 */
!function(e) {
  ...
  return function e(t, n, r) {
    ...
    1: [ function(_dereq_, module, exports) {
      var hasOwn, toString, clone, isUndef, isString, isObject, isArray, has, isArrayStrings;
    ...
    2: [ function(_dereq_, module, exports) {
      var oli, walk, ht, ref$, isObject, isArray, isString, isUndef, isArrayStrings, has, oml, exports, defaults, render, visitor, normalize, isDoctype;
      oli = _dereq_("oli");
      walk = _dereq_("./walk");
      ht = _dereq_("htgen");
      ref$ = _dereq_("./helpers"), isObject = ref$.isObject, isArray = ref$.isArray, isString = ref$.isString, 
      isUndef = ref$.isUndef, isArrayStrings = ref$.isArrayStrings, has = ref$.has;
      oml = exports = module.exports = {};
      oml.render = function(code, options) {
        return render(oli.parse(String(code)), options);
      };
      defaults = {
        pretty: false,
        indent: 2
        ...
        for (name in node) if (own$.call(node, name)) {
          ...
          if (child !== undefined) {
            ...
            if (isArray(child)) {
              ...
              if (child === null) {
                name += "!";
              } else if (has(child, "$$attributes")) {
                attrs = child.$$attributes;
                child = child.$$body;
              } else if (isObject(child)) {
                child = visitor(child);
              }
              buf.push(ht(name, attrs, child));
            }
          }
        }
        return buf;
    ...
    10: [ function(_dereq_, module, exports) {
      ...
      var generator = _dereq_("./generator");
      var _ = _dereq_("./helpers");
      var CompilerError = _dereq_("./errors").CompilerError;
    ...
    12: [ function(_dereq_, module, exports) {
      ...
      exports = module.exports = function oliRequireHandler(oli) {
        _dereq_.extensions[".oli"] = function(module, filename) {
    ...
    17: [ function(_dereq_, module, exports) {
      ...
      if (_.isBrowser) {
        _dereq_("./engine/browser")(oli);
      } else {
        _dereq_("./engine/node")(oli);
      }
    ...
    20: [ function(_dereq_, module, exports) {
      ...
      var _ = _dereq_("./helpers");
      var tokens = _dereq_("./tokens");
      var CompileError = _dereq_("./errors").CompileError;
